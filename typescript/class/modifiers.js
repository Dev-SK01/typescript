...
var Department = /** @class */ (function (_super) {
    ...
    Department.prototype.getStudentDetails = function () {
        ...
        return console.log({ Name: this.name, age: this.age, state: this.state, school: school, department: this.department, college: this.college, year: this.year });
    };
    Department.prototype.getCollegeDetails = function () {
